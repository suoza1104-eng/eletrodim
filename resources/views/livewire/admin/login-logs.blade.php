    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        @if($logs->isEmpty())
            <div class="p-12 text-center">
                <p class="text-gray-500">Nenhum registro de login encontrado.</p>
            </div>
        @else
                ...
                <table class="w-full min-w-[750px]">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50">
                            ...
                            <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Data / Hora</th>
                            <th class="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Mensagem</th>
                        </tr>
                    </thead>
