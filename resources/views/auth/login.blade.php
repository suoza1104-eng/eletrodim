...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transition-colors duration-200">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Bem-vindo de volta</h2>
    <p class="text-gray-500 dark:text-gray-400 text-sm mb-8">Faça login para continuar no EletroDIM</p>
    ...
    <form method="POST" action="{{ route('login.submit') }}" class="space-y-5">
        ...
        <div>
            ...
            <input type="email" name="email" value="{{ old('email') }}" required autofocus
                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-gray-100 dark:bg-gray-700 placeholder-gray-400 dark:placeholder-gray-500
